                                                    ...
                                                    <DialogContent className="max-w-2xl p-0 overflow-hidden">
                                                        <div className="bg-gradient-to-r from-primary/5 to-secondary/5 p-6 border-b border-border">
                                                            <div className="flex items-center gap-3">
                                                                ...
                                                                <div>
                                                                    <h2 className="text-xl font-bold text-foreground">Survey Details</h2>
                                                                    <p className="text-text-secondary text-sm">Complete information about this survey</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                                                                <div className="bg-surface/50 rounded-xl p-4 border border-border text-center">
                                                                    <div className="flex justify-center mb-2">
                                                                        <Badge variant={poll.isActive ? "default" : "outline"} className="text-sm">
                                                                            {poll.isActive ? 'Active' : 'Closed'}
                                                                        </Badge>
                                                                    </div>
                                                                ...
                                                                <div className="bg-surface/50 rounded-xl p-4 border border-border text-center">
                                                                    <div className="flex items-center justify-center gap-2 mb-2">
                                                                        <Users className="h-4 w-4 text-primary" />
                                                                        <span className="text-xl font-bold text-foreground">{poll.totalVotes}</span>
                                                                    </div>
                                                                ...
                                                                <div className="bg-surface/50 rounded-xl p-4 border border-border text-center">
                                                                    <div className="flex items-center justify-center gap-2 mb-2">
                                                                        ...
                                                                        <span className="text-xl font-bold text-foreground">{poll.options.length}</span>
                                                                    </div>
                                                                ...
                                                                <div className="bg-surface/50 rounded-xl p-4 border border-border text-center">
                                                                    <div className="flex items-center justify-center gap-2 mb-2">
                                                                        ...
                                                                        <span className="text-sm font-semibold text-foreground">{formatDate(poll.createdAt)}</span>
                                                                    </div>
                                                                ...
                                                                <div className="bg-surface/50 rounded-xl p-4 border border-border">
                                                                    ...
                                                                    <div className="space-y-3">
                                                                        {poll.options.map((option, index) => {
                                                                            ...
                                                                            return (
                                                                                <div key={option.id} className="flex items-center justify-between p-3 bg-background/50 rounded-lg border border-border/50 group hover:border-primary/30 transition-colors">
                                                                                    <div className="flex items-center gap-3 flex-1">
                                                                                        <div className="w-6 h-6 rounded-lg bg-primary/10 text-primary text-xs font-bold flex items-center justify-center">
                                                                                            {index + 1}
                                                                                        </div>
                                                                                        <span className="text-foreground font-medium flex-1">{option.text}</span>
                                                                                    </div>
                                                                                    <div className="flex items-center gap-3">
                                                                                        ...
                                                                                        <div className="text-right min-w-[80px]">
                                                                                            <div className="text-foreground font-semibold text-sm">{voteCount}</div>
                                                                                            <div className="text-text-secondary text-xs">({Math.round(percentage)}%)</div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            );
                                                            ...
                                                            <div className="bg-surface/50 rounded-xl p-4 border border-border">
                                                                ...
                                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                                                    ...
                                                                    <div className="flex items-center justify-between p-2">
                                                                        ...
                                                                        <span className="text-foreground">{formatDateTime(poll.createdAt)}</span>
                                                                    </div>
                                                                    {poll.expiresAt && (
                                                                        <div className="flex items-center justify-between p-2 md:col-span-2">
                                                                            ...
                                                                            <div className="flex items-center gap-2">
                                                                                ...
                                                                                <span className={`font-semibold ${new Date(poll.expiresAt) > new Date() ? 'text-orange-600' : 'text-red-600'}`}>
